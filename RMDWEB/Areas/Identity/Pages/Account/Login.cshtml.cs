    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if(ModelState.IsValid)
            {
                ...
                var user = _signInManager.UserManager.Users.Where(a => a.Email==Input.Email);
                ...
                if(result.IsLockedOut)
                {
                    ...
                    ActivityLog l = new ActivityLog();
                    l.Activity = "login/failed";
                    l.ActivityDate = DateTime.Now;
                    l.UserName = Input.Email;
                    l.TableName = "null";
                    l.Detail = "User account locked out";
                    _activitylog.Add(l);
                ...
                else
                {
                    ...
                    l.UserName = Input.Email;
                    l.TableName = "null";
                    l.Detail = "Invalid login attempt";
                    _activitylog.Add(l);
                    return Page();
                }
            }
